...
public class FilmDaoImplementation implements DaoInterfaces<FilmModel> {
	...
	public List<FilmModel> getAll() throws SQLException {
		...
		List<FilmModel> lstFilm = new ArrayList<FilmModel>();
